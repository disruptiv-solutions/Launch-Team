/**
 * Migration script to create a default team from existing agent setup
 * Run this once to migrate existing setup to the new teams system
 */
...
export async function migrateToDefaultTeam() {
  try {
    console.log('Starting migration to teams system...');

    // Check if agents already exist
    const { getAllAgentDefinitions } = await import('../lib/agentsEnhanced');
